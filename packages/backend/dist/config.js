...
// Centralized configuration — ALL values from .env / process.env with sensible defaults.
Object.defineProperty(exports, "__esModule", { value: true });
exports.config = void 0;
exports.config = {
    // Agent
    maxIterations: parseInt(process.env['PULSE_MAX_ITERATIONS'] || '5', 10) || 5,
    maxCallsPerSession: parseInt(process.env['PULSE_MAX_CALLS_PER_SESSION'] || '10', 10) || 10,
    ...
    // Server
    serverPort: parseInt(process.env['PULSE_SERVER_PORT'] || '3001', 10) || 3001,
    serverHost: process.env['PULSE_SERVER_HOST'] || '127.0.0.1',
};
